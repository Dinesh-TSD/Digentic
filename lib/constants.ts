...
export const MOCK_BLOG_POSTS = [
  {
    ...
    excerpt: 'Learn how to build autonomous AI agents that can reason, plan, and execute tasks using LangChain framework.',
    category: 'AI & LLM',
    readTime: '12 min read',
    publishDate: 'Aug 15, 2025',
    image: 'https://images.pexels.com/photos/8386440/pexels-photo-8386440.jpeg?auto=compress&cs=tinysrgb&w=800',
    author: { name: 'Dinesh T', avatar: 'https://images.pexels.com/photos/220453/pexels-photo-220453.jpeg' },
    views: 3240,
  },
  {
    id: '2',
    ...
    excerpt: 'A comprehensive walkthrough of building and deploying a full-stack MERN application with best practices.',
    category: 'MERN Stack',
  ...
  },
  {
    ...
    excerpt: 'Deep dive into how RAG combines retrieval and generation to build more accurate AI applications.',
    category: 'AI & LLM',
  ...
  {
    id: '4',
    title: 'TypeScript Best Practices for Next.js 15',
    slug: 'typescript-nextjs-best-practices',
    excerpt: 'Essential TypeScript patterns and practices for building type-safe Next.js applications at scale.',
  ...
  },
  {
    ...
    slug: 'deploying-ai-models-docker',
    excerpt: 'Step-by-step guide to containerizing and deploying machine learning models with Docker and AWS.',
    category: 'Dev Tools',
  ...
  },
  {
    ...
    slug: 'building-custom-gpts',
    excerpt: 'How to create domain-specific GPT models tailored to your business needs and data.',
    category: 'AI & LLM',
  ...
  {
    id: '7',
    title: 'Full-Stack Next.js App with AI Features',
    slug: 'fullstack-nextjs-ai-features',
    excerpt: 'Build a complete Next.js application integrated with AI capabilities using LangChain and OpenAI.',
    category: 'React / Next.js',
    readTime: '16 min read',
    publishDate: 'Jul 08, 2025',
    image: 'https://images.pexels.com/photos/270404/pexels-photo-270404.jpeg?auto=compress&cs=tinysrgb&w=800',
    author: { name: 'Dinesh T', avatar: 'https://images.pexels.com/photos/220453/pexels-photo-220453.jpeg' },
    views: 1780,
  },
  {
    ...
    slug: 'multi-agent-systems-ai',
    excerpt: 'Explore how multiple AI agents can collaborate to solve complex problems beyond single-agent capabilities.',
    category: 'AI & LLM',
  ...
  {
    id: '9',
    title: 'MongoDB Optimization Tips for Performance',
    slug: 'mongodb-optimization-tips',
    excerpt: 'Advanced strategies to optimize MongoDB queries and improve database performance for production apps.',
    category: 'MERN Stack',
    readTime: '9 min read',
  ...
  {
    id: '10',
    title: 'Freelancing Guide: Getting Your First AI Project',
    slug: 'freelancing-first-ai-project',
    excerpt: 'A practical guide to landing and completing your first AI/ML freelancing project successfully.',
  ...
  {
    id: '11',
    title: 'Understanding Prompt Engineering at Scale',
    slug: 'prompt-engineering-scale',
    excerpt: 'Master the art of prompt engineering to get consistent, reliable results from large language models.',
    category: 'AI & LLM',
    readTime: '11 min read',
  ...
  {
    id: '12',
    title: 'React Hooks: Advanced Patterns and Custom Hooks',
    slug: 'react-hooks-advanced-patterns',
    excerpt: 'Deep dive into React Hooks with advanced patterns and techniques for building performant components.',
    category: 'React / Next.js',
    readTime: '12 min read',
